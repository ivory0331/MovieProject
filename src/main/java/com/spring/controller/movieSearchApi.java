...
import java.io.IOException;
 ...
 public class movieSearchApi { 
	 public static void main(String[] args) throws IOException { 
		 ...
		 urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") +"=5NJ940S18D027BYP2UY4"); /*Service Key*/ 
		 urlBuilder.append("&" + URLEncoder.encode("val001","UTF-8") + "=" + URLEncoder.encode("2020", "UTF-8")); /*상영년도*/
