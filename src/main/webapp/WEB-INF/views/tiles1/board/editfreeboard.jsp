	...
	$(document).ready(function(){
	    ...
	    */    
	     ...
	     // alert(contentval);
	         ...
	         frm.method = "POST";
	         frm.action = "<%= ctxPath%>/editfreeboardEnd.mv";
	         frm.submit();
	      });
...
<div id ="container"><br>
	<div id="wholeNotice">
		...
		<div>
		<form name="editFrm" enctype="multipart/form-data"> <!-- enctype="multipart/form-data" -->
			<table id="table" style="margin: 0 auto; width: 1040px; background-color: white;">
				<tr>
					<th>제목</th>
					<td>
						<input type="hidden" size="50" id="title" name="post_seq" value="${freeboardvo.post_seq}"/>
				...
				<tr>
					<th>작성자</th>
					<td>
						<input type="text" name="nickname" value="${freeboardvo.nickname}" readonly />
				...
				<tr>
					<th>내용</th>
					<td><textarea rows="15" cols="110" style="width:766px; height:412px;" id="content" name="content">${freeboardvo.content}</textarea></td>
				</tr>
